...
export default {
    ...
    beforeRouteEnter(to, from, next){
        const users = [
            ...
            { id: 43151, token: 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJjdXN0b21lciI6IjQzMTUxIiwiZ2VyYWRvIjoiMjAyMC0wOS0yNCAwMzowNjozOCJ9.MWXX-B6t5Ay-oXkfEZTVv6KzJAEEDOqzy3tPq9mg5ro', identification: process.env.VUE_APP_TOKEN_SERVICE_USER || '', page: 'UserView' },
            ...
            { id: 375, token: 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzaG9wIjoiMzc1IiwiZ2VyYWRvIjoiMjAyMC0wOS0yNCAwMzowNjozOCJ9.O1doLGp_BcWJOfT35ud35uyTkdDp6inCWlbAO6nls8w', identification: process.env.VUE_APP_TOKEN_SERVICE_RESTAURANT || '', page: 'RestView' },
            ...
            { id: 341, token: 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJkZWxpdmVyeSI6IjM0MSIsImdlcmFkbyI6IjIwMjAtMDktMjQgMDM6MDY6MzgifQ.M0z2HM4Tub_Vzxn-NkfFx2GOyFU4FrwcCyTdEwpWFfE', identification: process.env.VUE_APP_TOKEN_SERVICE_DELIVERY || '', page: 'MotoView' },
        ...
        const user = users.find(user => user.token === to.params.accountAuth);
        if(user){
            return next(vm => {
